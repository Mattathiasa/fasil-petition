...
function Confetti() {
  const particles = Array.from({ length: 24 }, (_, i) => ({
    ...
    color: ['#CC0000', '#ff4444', '#ffaa00', '#4ade80', '#fff'][i % 5],
...
export default function SignatureCounter() {
  ...
  const checkMilestone = useCallback(() => {
    ...
    for (const m of MILESTONES) {
      if (prevCount.current < m && count >= m) {
        setCelebrating(true)
  ...
  return (
    <>
      ...
      `}</style>
      <div className="rounded-2xl overflow-hidden relative" style={{ background: '#111', border: '1px solid #1e1e1e' }}>
          ...
          <div>
            {count === null ? (
              ...
              <p
                ...
                style={celebrating ? { animation: 'milestone-pulse 0.5s ease 3', color: '#ffaa00' } : {}}
              >
